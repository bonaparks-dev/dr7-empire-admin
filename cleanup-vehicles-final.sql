...
UPDATE vehicles SET daily_rate = 249, status = 'available', display_name = 'Mercedes V Class VIP DR7', metadata = jsonb_set(COALESCE(metadata, '{}'::jsonb), '{pricing}', '{"daily": 249, "ncc": "Preventivo"}'::jsonb) WHERE display_name LIKE 'Mercedes%Classe V%' OR display_name LIKE 'Mercedes-Benz Classe V%';
